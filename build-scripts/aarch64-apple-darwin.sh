...
mkdir -p "$BASE_PATH/release/$library/$VERSION/macos/aarch64-apple-darwin"
mv "$file" "$BASE_PATH/release/$library/$VERSION/macos/aarch64-apple-darwin/aarch64-apple-darwin_lib$package_name.a"
cd ../../../
echo "✅ aarch64-apple-darwin build completed. Binary in release/$library/$VERSION/macos/x86_64-apple-ios/ folder."